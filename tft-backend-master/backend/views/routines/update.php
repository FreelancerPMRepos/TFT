...
$this->title = 'Update Routines: ' . Pathways::findOne(['id'=>$model->pathway_id])->name ." ".$model->day;
$this->params['breadcrumbs'][] = ['label' => 'Routines', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => Pathways::findOne(['id'=>$model->pathway_id])->name ." ".$model->day, 'url' => ['view', 'id' => $model->id]];
$this->params['breadcrumbs'][] = 'Update';
?>
<div class="row routines-update">
