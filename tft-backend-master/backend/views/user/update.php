...
$this->title = 'Update '.$type.': ' . $model->username;
$this->params['breadcrumbs'][] = isset($_GET['t_id'])? ['label' => $type, 'url' => ['index','id'=>$_GET['id']]] : ['label' => $type, 'url' => ['index']];
$this->params['breadcrumbs'][] = isset($_GET['t_id'])? ['label' => $model->username, 'url' => ['view', 'id' => $model->id,'t_id'=>$_GET['t_id']]] : ['label' => $model->username, 'url' => ['view', 'id' => $model->id]];
