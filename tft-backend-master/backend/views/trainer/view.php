...
$this->title = 'Details of Trainer';//.$model['id'];
					...
					<div class="card-panel">
						<div class="row">
							...
							<div class="col s12 m5 quick-action-btns display-flex justify-content-end align-items-center pt-2">
								<a href="<?= Url::toRoute(['/user/update-trainer?id='. $model['user_id']], $schema = true)?>" class="btn-small indigo">Edit</a>
							</div>
						</div>
					</div>
					<div class="card">
											...
											<tr>
												...
												<td>
													<div class="switch">
														<label>
															Block														
															<input type="checkbox" class="user-status-checkbox" data-user="<?php echo $model['id']; ?>" value="1" 
								...
								<div class="col s12">
									...
									<table class="striped">
										<tbody>
											...
											<tr>
												<td>BMI:</td>
												<td><?= \Yii::$app->general->bmi( $model['height'],$model['weight']); ?></td>
											</tr>
										</tbody>
									</table>
								</div>
