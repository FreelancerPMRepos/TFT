...
API_KEY="6c0c7c64d2ddc38b0274f5207eca3c50"
declare -A CODEPUSH_PROJECTS  
declare PLATFORMS

CODEPUSH_PROJECTS=( [android]=TFT [ios]=kashtah-iOS )
   ...
   for variant in "${VARIANTS[@]}"
    do
        ...
        then
            ...
            code-push release ${CODEPUSH_PROJECTS[$platform]} ./$BUNDLE_PATH $C_APP_VERSION $IS_MANDATORY --description "$UPDATE_DESCRIPTION" --deploymentName Production --noDuplicateReleaseError
